                ...
                <figure class="gallery__inner">
                  ...
                  <figcaption>
                    <div class="gallery__inner__caption">
                      ...
                      <a href=<?php echo get_site_url()."/products/furniture?category_name=furniture"?> >View More</a>
                    </div>
                  </figcaption>
                </figure>
              </div>
              ...
              <div class="col-md-6">
                <figure class="gallery__inner">
                  ...
                  <figcaption>
                    <div class="gallery__inner__caption">
                      <h5>FigCaption Header</h5>
                      <a href=<?php echo get_site_url()."/products/home-decor?category_name=home-decor"?> >View More</a>
                    </div>
                  </figcaption>
                </figure>
              </div>
